...
export class CreateProjectTable1613168317639 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'DROP TYPE "public"."project_project_priority_enum"',
    )
  }
}
